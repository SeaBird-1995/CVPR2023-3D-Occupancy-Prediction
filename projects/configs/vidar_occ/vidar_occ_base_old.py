...
Date: 2024-01-13 08:56:40
Email: haimingzhang@link.cuhk.edu.cn
Description: The implemented vidar config based on BEVFormer.
'''
_base_ = [
...
dataset_type = 'NuScenesViDARDataset'
...
data = dict(
    ...
    train=dict(
        ...
        times=1,
        data_root=data_root,
        ann_file=data_root + 'occ_infos_temporal_train_scene.pkl',
    ...
    val=dict(type=dataset_type,
             ...
             offset=0,
             data_root=data_root,
             ann_file=data_root + 'occ_infos_temporal_val_scene.pkl',
