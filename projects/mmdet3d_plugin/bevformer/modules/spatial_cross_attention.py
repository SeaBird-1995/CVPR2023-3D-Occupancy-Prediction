...
@ATTENTION.register_module()
class SpatialOccCrossAttention(BaseModule):
    """An attention module used to interact with current occupancy feature.
    Args:
        embed_dims (int): The embedding dimension of Attention.
            Default: 256.
        num_cams (int): The number of cameras
    ...
    def __init__(self,
        ...
        super(SpatialOccCrossAttention, self).__init__(init_cfg)
